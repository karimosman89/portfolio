    ...
    <div className="relative w-full">
      ...
      <section id="top" className="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 pb-16 pt-32 md:px-8">
        <div className="grid w-full items-center gap-12 lg:grid-cols-12">
          ...
          >
            <motion.div variants={fade} className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-400/10 px-4 py-1.5 text-[11px] font-mono uppercase tracking-wider text-emerald-400">
            ...
            <motion.h1 variants={fade} className="font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-[var(--text)] md:text-6xl lg:text-[4.2rem]">
              ...
              <TypeRoles />
              <br />
              <span className="text-[var(--text-muted)] font-light">into production.</span>
            </motion.h1>
            ...
            <motion.div variants={fade} className="mt-9 flex flex-wrap items-center gap-3">
              <a href="#contact" className="btn-primary inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-sm font-bold">
