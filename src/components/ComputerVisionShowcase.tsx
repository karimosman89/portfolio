...
const cvProjects: CVProject[] = [
  {
    ...
    xai: {
      confidence: 0.987,
      reasoning: "High confidence due to clear skeletal landmarks on the distal phalanges and metacarpal joints. Background noise suppressed via adaptive thresholding.",
    }
  },
  {
    id: 'autonomous-drone',
    ...
    xai: {
      confidence: 0.942,
      reasoning: "Obstacle detection triggered by depth-map disparity. Path recalculated using A* algorithm to maintain a 2-meter safety buffer from structural boundaries.",
    }
  },
  {
    id: 'retail-analytics',
    ...
    xai: {
      confidence: 0.915,
      reasoning: "Heatmap generated by temporal aggregation of centroid coordinates. Demographic inference based on facial feature extraction and gait analysis.",
    }
  }
];
...
export default function ComputerVisionShowcase() {
  ...
  return (
    <section id="cv-showcase" className="mx-auto max-w-7xl px-6 py-24 md:px-8 border-t border-zinc-200/80 dark:border-zinc-800">
      {/* Section Header */}
      <motion.div
                      ...
                      <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800">
                        ...
                        <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-100 dark:border-zinc-700">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-[10px] font-mono font-bold text-emerald-500">{(project.xai.confidence * 100).toFixed(1)}%</span>
                          </div>
                          <div className="w-full h-1 bg-zinc-200 dark:bg-zinc-700 rounded-full overflow-hidden mb-3">
                            <motion.div
                              initial={{ width: 0 }}
                              animate={{ width: `${project.xai.confidence * 100}%` }}
                              transition={{ duration: 1, delay: 0.5 }}
                              className="h-full bg-emerald-500"
                            />
                          </div>
                          <p className="text-[11px] text-zinc-600 dark:text-zinc-400 leading-relaxed italic">
                            "{project.xai.reasoning}"
                          </p>
                        </div>
                      </div>
                    )}
